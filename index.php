            ...
            <section>
                ...
                <div class="card-container">
                        ...
                        <div class="card">
                            <a class="card-link" href="projects/SwedenFullPHP/" target="_blank">
                            <div class="card-front">
                                <img src="images/Project1Card.png" alt="Sweden Slideshow Page">
                                <!-- <div class="card-text"><h4>Sweden JavaScript Slideshow</h4>
                                <p>I did this project for fun to explore some nuances of JavaScript and experiment with various jQuery plugins.</p></div> -->
                            </div>
                            </a>
                ...
                <!-- <div class="project-container">
                    <a class="project-link" href="projects/SwedenFullPHP/" target="_blank">
                ...
                <!-- <a class="card-link" href="https://github.com/Dellman/lendandlease.app.git" target="_blank"><div class="card" id="lendAndLeaseBG"> -->
                    <!-- <div class="card-front">
                        <img src="" alt="">
                    </div> -->
                    <!-- <div class="card-back">    <h4>Lend and Lease</h4>
                ...
                <!-- <a class="card-link" href="projects/ClientProject1/index.html" target="_blank"><div class="card" id="project1BG"> -->
                    <!-- <div class="card-front">
                        <img src="images/Project1Card.png" alt="Dynamic JavaScript Page">
                    </div> -->
                ...
                <!-- <a class="card-link" href="http://strategicinterests.com/" target="_blank"><div class="card" id="strategicInterestsBG"> -->
                    <!-- <div class="card-front">
                        <img src="images/StrategicInterestsCard2.png" alt="Stragic Interests Page">
                    </div> -->
                    <!-- <div class="card-back">
